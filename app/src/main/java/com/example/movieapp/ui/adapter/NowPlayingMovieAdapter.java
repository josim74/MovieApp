...
public class NowPlayingMovieAdapter extends RecyclerView.Adapter<NowPlayingMovieAdapter.NowPlayingViewHolder> {
    ...
    public NowPlayingMovieAdapter(ArrayList<Movies> movieList, Context context) {
        this.movieList = movieList;
        this.context = context;
    }

    public void setNowPlayingMovies(ArrayList<Movies> movieList) {
        this.movieList = movieList;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull NowPlayingViewHolder holder, final int position) {
