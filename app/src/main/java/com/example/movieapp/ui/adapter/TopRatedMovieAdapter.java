...
public class TopRatedMovieAdapter extends RecyclerView.Adapter<TopRatedMovieAdapter.TopRatedViewHolder> {
    ...
    public TopRatedMovieAdapter(ArrayList<Movies> movieList, Context context) {
        this.movieList = movieList;
        this.context = context;
    }

    public void setTopRatedMovies(ArrayList<Movies> movieList) {
        this.movieList = movieList;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull TopRatedViewHolder holder, final int position) {
